...
COMPOSER=composer_build.json composer show -d dev-tools humbug/box -q || COMPOSER=composer_build.json composer update -d dev-tools --no-interaction --no-progress
